...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Insider Cart Count",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "This template gets cart count from dataLayer. You should specify the variable. It interprets dots as nested values. For example, \"a.b.c\" as three nested levels: {a:",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "cartCount",
    "displayName": "Cart Count Variable",
...
insiderObject.basket.total_count = getData(data.cartCount);
...
Created on 11/20/2020, 3:01:10 PM
